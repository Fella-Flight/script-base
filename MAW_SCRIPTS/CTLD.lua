...
--pickupZones = { "Zone name or Ship Unit Name", "smoke color", "limit (-1 unlimited)", 
--"ACTIVE (yes/no)", "side (0 = Both sides / 1 = Red / 2 = Blue )", flag number (optional) }
ctld.pickupZones = {
    { "logi-rota-1", "green", -1, "yes", 0 },
    ...
    --{ "pickzone9", "green", 5, "yes", 1 }, -- limits pickup zone 9 to 5 groups of soldiers or vehicles, only red can pick up
    --{ "pickzone10", "green", 10, "yes", 2 },  -- limits pickup zone 10 to 10 groups of soldiers or vehicles, only blue can pick up
    { "Harry", "green", -1, "yes", 2 }, -- Harry S Truman Carrier
    { "Saratoga", "green", -1, "yes", 2 }, -- Forrestal Carrier
...
-- TODO see if we have to do anythign with this later
ctld.hoverExempt = {
    "Yak-52",
    "TF-51D",
    "C-101EB",
...
ctld.unitActions = {
    ...
    ["C-101EB"] = {crates=true, troops=false},
...
ctld.spawnableCrates = {
	...
	{ weight = 548, desc = "HAWK CWAR", unit = "Hawk cwar" , side = 2 }, -- Remove this if on 2.5	
        ...
        -- NASAMS Sysyem
        { weight = 541, desc = "NASAMS Launcher 120C", unit = "NASAMS_LN_C", side = 2},
        { weight = 544, desc = "NASAMS Search/Track Radar", unit = "NASAMS_Radar_MPQ64F1", side = 2 },
        { weight = 543, desc = "NASAMS Command Post", unit = "NASAMS_Command_Post", side = 2 },
        { weight = 542, desc = "NASAMS Repair", unit = "NASAMS Repair", side = 2 },
        -- End of NASAMS
...
function ctld.addCallback(_callback)
    trigger.action.outText("I'm so mad", 30)
    dump(ctld.callbacks)

    if ctld.callbacks == nil then
        -- TODO fix before full release?
        -- if somehow the table is not here when this gets called fix it
